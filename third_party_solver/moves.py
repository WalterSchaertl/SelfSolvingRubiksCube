...
fname = misc.get_table("move_twist")
...
fname = misc.get_table("move_flip")
if not path.isfile(fname):
    print("creating " + fname + " table...")
...
fname = misc.get_table("move_slice_sorted")
if not path.isfile(fname):
    print("creating " + fname + " table...")
...
fname = misc.get_table("move_u_edges")
if not path.isfile(fname):
    print("creating " + fname + " table...")
...
fname = misc.get_table("move_d_edges")
if not path.isfile(fname):
    print("creating " + fname + " table...")
...
fname = misc.get_table("move_ud_edges")
if not path.isfile(fname):
    print("creating " + fname + " table...")
...
fname = misc.get_table("move_corners")
if not path.isfile(fname):
    print("creating " + fname + " table...")
