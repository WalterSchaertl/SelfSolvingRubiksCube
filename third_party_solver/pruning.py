...
from . import misc, defs, enums, moves as mv, symmetries as sy, cubie as cb
from os import path
import time
import array as ar
...
def create_phase1_prun_table():
    ...
    fname = misc.get_table("phase1_prun")
...
def create_phase2_prun_table():
    ...
    fname = misc.get_table("phase2_prun")
...
def create_phase2_cornsliceprun_table():
    ...
    fname = misc.get_table("phase2_cornsliceprun")
