...
fname = misc.get_table("conj_twist")
...
fname = misc.get_table("conj_ud_edges")
if not path.isfile(fname):
    print("creating " + fname + " table...")
...
fname1 = misc.get_table("fs_classidx")
fname2 = misc.get_table("fs_sym")
fname3 = misc.get_table("fs_rep")
...
fname1 = misc.get_table("co_classidx")
fname2 = misc.get_table("co_sym")
fname3 = misc.get_table("co_rep")
if not (path.isfile(fname1) and path.isfile(fname2) and path.isfile(fname3)):
